...
export type HardwareInfo = { cpuBrand: string; physicalCores: number; logicalCores: number; totalMemoryMb: number; availableMemoryMb: number; osName: string; osVersion: string; arch: string; isBmi2: boolean; isAvx2: boolean; recommendedThreads: number; recommendedHashMb: number }
