...
export type HardwareInfo = { cpuBrand: string; physicalCores: bigint; logicalCores: bigint; totalMemoryMb: number; availableMemoryMb: number; osName: string; osVersion: string; arch: string; isBmi2: boolean; isAvx2: boolean; recommendedThreads: bigint; recommendedHashMb: number }
