...
export type AnalysisOptions = { fen: string; moves: string[]; annotateNovelties: boolean; referenceDb: string | null; reversed: boolean; bestMovesCount: number }
...
export type HardwareInfo = { cpuBrand: string; physicalCores: number; logicalCores: number; totalMemoryMb: number; availableMemoryMb: number; gpuBrand: string; vramMb: number | null; osName: string; osVersion: string; arch: string; isBmi2: boolean; isAvx2: boolean; recommendedThreads: number; recommendedHashMb: number }
